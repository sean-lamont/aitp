...
%    Our system was designed to accommodate both approaches, making it possible to, for example generate
%    node embeddings in
...
%    this component reduces to embedding the expression of the selected goal $g \in s'$.
...
%
%\paragraph{Book with multiple authors~\nocite{em:86}} Use the \texttt{@book} class.\\
%\bibentry{em:86}.
%
